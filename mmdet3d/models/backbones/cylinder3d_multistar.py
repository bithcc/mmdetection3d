...
class Multistar_ResBlock(BaseModule):
    ...
    def __init__(self,
        ...
        self.conv0_2 = SubMConv3d(
            ...
            bias=False,
            indice_key=indice_key + 'bef')
        self.act0_2 = build_activation_layer(act_cfg)
        self.bn0_2 = build_norm_layer(norm_cfg, out_channels)[1]
        ...
        self.conv1_2 = SubMConv3d(
            ...
            bias=False,
            indice_key=indice_key + 'bef')
        self.act1_2 = build_activation_layer(act_cfg)
        self.bn1_2 = build_norm_layer(norm_cfg, out_channels)[1]
        ...
        self.conv2_1 = SubMConv3d(
            ...
            bias=False,
            indice_key=indice_key + 'bef')
        self.act2_1 = build_activation_layer(act_cfg)
        self.bn2_1 = build_norm_layer(norm_cfg, out_channels)[1]

        self.conv2_2 = SubMConv3d(
            out_channels,
            out_channels,
            kernel_size=(3, 1, 3),
            padding=1,
            bias=False,
            indice_key=indice_key + 'bef')
        self.act2_2 = build_activation_layer(act_cfg)
        self.bn2_2 = build_norm_layer(norm_cfg, out_channels)[1]
    ...
    def forward(self, x: SparseConvTensor) -> SparseConvTensor:#3月29日,sparseconvtensor forward,这里之后进行修改
        ...
        temp2_shortcut = shortcut
        
        shortcut = self.conv0_2(shortcut)
        shortcut.features = self.act0_2(shortcut.features)
        ...
        res.features = self.act1_2(res.features)
        res.features = self.bn1_2(res.features)
        ...
        res2.features = self.act2_1(res2.features)
        res2.features = self.bn2_1(res2.features)
        
        temp2_res2 = res2
        
        res2 = self.conv2_2(res2)
        res2.features = self.act2_2(res2.features)
        res2.features = self.bn2_2(res2.features)


        res.features = res.features + shortcut.features + res2.features
        temp_res.features = temp_shortcut.features + temp_res.features + temp_res2.features
        temp2_res.features = temp2_shortcut.features + temp2_res.features + temp2_res2.features
        
        res.features = res.features * temp_res.features
        res.features = res.features * temp2_res.features
...
class Multistar_DownBlock(BaseModule):
...
class Multistar_UpBlock(BaseModule):
    ...
    def forward(self, x: SparseConvTensor,
        ...
        up.features = up.features * up_x.features
...
class Multistar_3DSpconv(BaseModule):
    ...
    def __init__(self,#关注重点
        ...
        self.down_context = Multistar_ResBlock(#关注重点
