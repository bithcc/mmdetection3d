...
class Multilite_ResBlock(BaseModule):
...
class Multilite_DownBlock(BaseModule):
...
class Multilite_UpBlock(BaseModule):
...
class Multilite_3DSpconv(BaseModule):
    ...
    def __init__(self,#关注重点
        ...
        self.down_context = Multilite_ResBlock(#关注重点
