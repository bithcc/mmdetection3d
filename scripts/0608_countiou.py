...
# 示例调用
bin_folder = '/mnt/datasets/huichenchen/robosense/rs32/label_bin'
json_folder = '/mnt/datasets/huichenchen/robosense/rs32/multi-json/preds'
output_file = '/mnt/datasets/huichenchen/robosense/rs32/rs32-multi-iou_results.txt'
...
# output_file = '/mnt/datasets/huichenchen/robosense/rs128/rs128-multi-iou_results.txt'
# main(bin_folder, json_folder, output_file)
