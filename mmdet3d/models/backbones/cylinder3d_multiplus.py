...
class Multi_ResBlock(BaseModule):
...
class Multi_DownBlock(BaseModule):
...
class Multi_UpBlock(BaseModule):
...
class MultiplusDDCMBlock(BaseModule):
...
class Multiplus_3DSpconv(BaseModule):
    ...
    def __init__(self,#关注重点
        ...
        self.down_context = Multi_ResBlock(#关注重点
